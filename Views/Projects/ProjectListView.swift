...
struct ProjectListView: View {
    ...
    var body: some View {
        // Skill: NavigationStack with value-based NavigationLink + .navigationDestination (iOS 16+)
        NavigationStack {
            Group {
            ...
            // Skill: value-based destination declaration attached to NavigationStack
        ...
        ScrollView {
            LazyVStack(spacing: 12) {
                ForEach(activeProjects) { project in
                    // Skill: NavigationLink(value:) — type-safe, value-based navigation
                    NavigationLink(value: project) {
                        ProjectCard(project: project)
                    }
                    .buttonStyle(.plain)
                    .sensoryFeedback(.selection, trigger: project.id)
                    .contextMenu {
                        Button {
